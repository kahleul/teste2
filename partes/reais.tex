...
\begin{teo}[da Recursão]
    Sejam $(N, s, 1)$ um sistema de Peano, $X$ um conjunto, $x_0 \in X$ e $g:X \to X$ uma função. Existe e é única a função $f : N \to X$ tal que
        \begin{itemize}
            \item $f(1) = x_0$;
            \item $f(s(n)) = g(f(n))$, para todo $n \in N$.
        \end{itemize}
\end{teo}

...
\begin{proof}
    Tomando $X = \N_{\F_2}$, $a = 1_{\F_2}$ e $f: \N_{\F_2} \to \N_{\F_2}$ dada por $f(n) = n +_2 1_{\F_2}$ no teorema da recursão \eqref{teo.reais:recursão}, existe uma única função $\varphi : \N_{\F_1} \to \N_{\F_2}$ tal que $\varphi(1_{\F_1}) = 1_{\F_2}$ e $\varphi(n +_1 1_{\F_1}) = f[\varphi(n)] = \varphi(n) +_2 1_{\F_2}$.
        \begin{enumerate}[label=\roman*.]
            \item Provemos a bijetividade de $\varphi$ construíndo explicitamente sua função inversa. Tomando $X = \N_{\F_1}$, $a = 1_{\F_1}$ e $g: \N_{\F_1} \to \N_{\F_1}$ dada por $g(n) = n +_1 1_{\F_1}$ no teorema da recursão \eqref{teo.reais:recursão}, existe uma única função $\psi : \N_{\F_2} \to \N_{\F_1}$ tal que $\psi(1_{\F_2}) = 1_{\F_1}$ e $\psi(n +_2 1_{\F_2}) = g[\psi(n)] = \psi(n) +_1 1_{\F_1}$. Vamos provar que $\psi \circ \varphi = \id_{\F_1}$ e $\varphi \circ \psi = \id_{\F_2}$. Sendo $F := \psi \circ \varphi : \N_{\F_1} \to \N_{\F_1}$, temos
                \[

...
\begin{defi}
    ...
    , denotado por $\Q$, é definido como $\Q := \{ p \cdot q^{-1} : p \in \Z, q \in \Z_{\neq 0} \}$. Denotaremos $p \cdot q^{-1}$ por $\frac{p}{q}$.
\end{defi}

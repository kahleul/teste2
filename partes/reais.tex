...
\begin{teo}
    Sejam $(\F_1, +_1, \cdot_1, \leq_1)$ e $(\F_2, +_2, \cdot_2, \leq_2)$ corpos ordenados. Existe uma única bijeção $\varphi : \N_{\F_1} \to \N_{\F_2}$ tal que, para quaisquer $m,n \in \N_{\F_1}$, valem as seguintes afirmações.
        \begin{enumerate}[label=\roman*.]

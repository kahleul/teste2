...
\begin{proof}
    Ver \cite{guidorizzi2}, página 113. \itemproof
\end{proof}
...
\begin{proof}
    Ver \cite{guidorizzi2}, p. 124. \itemproof
\end{proof}
...
\begin{proof}
    Ver \cite{guidorizzi2}, p. 165, exemplo 4. \itemproof
\end{proof}
...
\begin{proof}
    Ver \cite{guidorizzi2}, pg. 170, Teorema 1. \itemproof
\end{proof}

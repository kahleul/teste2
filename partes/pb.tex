...
\begin{proof}
    \leavevmode
        \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
            \item Temos $\Omega \in \mathcal{F}$, de modo que $\Omega^{C} \in \mathcal{F}$, isto é, $\emptyset \in \mathcal{F}$. \itemproof
            \item \itemproof
        \end{enumerate}
\end{proof}
...
\begin{proof}
    \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
        \item Temos $\Pb(\emptyset) \geq 0$. Notando que $\ds \Pb(\emptyset) = \Pb\left( \bigcup_{n \in \N} \emptyset \right) = \sum_{n \in \N} \Pb(\emptyset)$, só pode ser $\Pb(\emptyset) = 0$. \itemproof
    \end{enumerate}
\end{proof}
...
\begin{proof}
    Ver \cite{rolla}, proposição 2.2. \itemproof
\end{proof}
...
\begin{proof}
    Basta fazer indução em $n$. Ver \cite{rolla}, teorema 2.5. \itemproof
\end{proof}
